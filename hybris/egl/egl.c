...
EGLBoolean eglInitialize(EGLDisplay dpy, EGLint *major, EGLint *minor)
{
	...
	EGLBoolean ret = _eglInitialize(real_display, major, minor);
	if (ret) {
...
EGLBoolean eglGetConfigAttrib(EGLDisplay dpy, EGLConfig config, EGLint attribute, EGLint *value) {
	...
	ret = (*_eglGetConfigAttrib)(real_display, config, attribute, value);
...
static struct FuncNamePair _eglHybrisOverrideFunctions[] = {
	...
	OVERRIDE_SAMENAME(eglQueryDmaBufModifiersEXT),
	OVERRIDE_SAMENAME(eglInitialize),
